            ...
            <div class="col-md-12">
                <div class="card" style=" border-radius: 25px; padding: 8px; border: 5px solid #BDE626; background-color:#474747;" >
                    ...
                    <div class="card-body" style="background: #BDE626; border-bottom-left-radius: 15px;  border-bottom-right-radius: 15px">
                        <div class="row">
                            <div class="col-md-5 col-xs-12"><img style="border-radius: 10%; padding: 4px; margin: 0px;border: 5px solid #474747;background-color:#BDE626;object-fit: cover;width:250px" src="{{ asset('img/user.png') }}"></div>

                            <div class="col-md-4 col-xs-12 text-left">
                            <h3 class="pt-5 pl-1 textgray" style="font-weight: bold">{{Auth::user()->name}}</h3>
                                <div class="col-12">
